...
<head>
    ...
    <title>Thrift Online Shop - <?php echo $__env->yieldContent('title', 'Home'); ?></title>
    <!-- Bootstrap CSS -->
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('cart.index')); ?>">
                                ...
                                <?php if(auth()->user()->carts->count() > 0): ?>
                                    <span class="badge bg-danger rounded-pill"><?php echo e(auth()->user()->carts->count()); ?></span>
                                <?php endif; ?>
                            </a>
                        </li>
                        <li class="nav-item">
...
</html><?php /**PATH C:\laragon\www\thrift-shop\thrift-shop\resources\views/layouts/app.blade.php ENDPATH**/ ?>